...
*/
    ...
    if (location.host === 'test' && req.method == "OPTIONS") {
      res.writeHead(200,  { "Access-Control-Allow-Origin": req.headers["referer"], "Access-Control-Allow-Methods": "POST, OPTIONS", "Access-Control-Allow-Credentials": "true", "Access-Control-Allow-Headers": "content-type" } );
      res.end("")
      return;
    }
